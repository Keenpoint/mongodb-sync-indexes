...
So, if you're only interested in the creation event (for logging or debugging purposes), you can disable the logging in the options and personalize your eventHandler properly:
